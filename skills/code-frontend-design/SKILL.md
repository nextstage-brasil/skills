...
See `../nextstage-harness/references/harness-discovery.md`. Read `{harness_root}/rules/architecture-rules.md` and layer-specific frontend rules when present.
...
- Replacing `code-reviewer` for MR gates
