...
- Local ad-hoc coding without an issue → `ns-code-coder` (priority 5)
- Autonomous local plan without issue → `ns-code-autonomous` (priority 3)
- Diagnosis-only without execution intent → `ns-code-investigator` (priority 4)
