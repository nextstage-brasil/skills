...
Do **not** restate the full stack here when `.nextstage-harness/rules/architecture-rules.md` exists.

| Source | Path |
| ------ | ---- |
| Constitution | `.nextstage-harness/rules/architecture-rules.md` |
...
- {bullet — actionable for `/ns-spec-driven` Specify / Clarify}
- {bullet}
