...
- Living specs live under `{specs_root}/` — see `ns-sdd-living-spec-consolidator` skill.
...
See `ns-sdd-version-partitioner` skill and `core-subversions` rule when present in harness.
