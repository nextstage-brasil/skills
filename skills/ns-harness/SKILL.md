...
| `references/subagent-dispatch.md` | Spawn gate: cheap vs heavy execute; **MUST** exact `{name}` when gate requires. **FORBIDDEN** child Task `inherit` / platform `coder` / `reviewer` |
