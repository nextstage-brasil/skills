...
See `../nextstage-harness/references/harness-discovery.md`. Resolve `{product_root}` from `AGENTS.md`.
...
| Runbooks, install guides, architecture overviews for humans | Living specs in `docs/specs/` (use `pm-living-spec-consolidator`) |
