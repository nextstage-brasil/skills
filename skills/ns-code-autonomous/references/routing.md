...
- The human asks for autonomous multi-step implementation without pointing at an existing SDD version's `execution-handoff.md` (that case belongs to `ns-execution-orchestrator` instead — redirect if you detect it).
