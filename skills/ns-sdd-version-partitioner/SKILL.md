---
name: ns-sdd-version-partitioner
...
See `../ns-harness/references/artifact-layout.md` and `../ns-harness/references/harness-discovery.md`. Read `core-subversions` rule from harness when present.
