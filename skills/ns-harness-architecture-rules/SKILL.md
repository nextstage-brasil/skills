...
- `ns-harness-bootstrap-brownfield` — `brownfield-map.md` for SDD planning (broader, planning-oriented)
- `ns-harness-codebase-reverse-spec` — technology-agnostic **business** behavior
- `ns-harness` — artifact paths and gate conventions
