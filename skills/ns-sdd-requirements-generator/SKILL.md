...
See `../ns-harness/references/harness-discovery.md` and `../ns-harness/references/artifact-layout.md`. Create `{product_root}/docs/versions/{version_san}/` before writing.

## Inputs

- Scope description (possibly enriched by `ns-sdd-clarify-requirements`)
