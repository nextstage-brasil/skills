...
description:
  ...
  **Issue mode:** given ISSUE_URL, read issue and comments via MCP, investigate codebase,
  ...
  (ns-execution-gitlab-issue), code review (ns-code-reviewer), version planning
  (start_execution_planning), or generating requirements.md (ns-sdd-requirements-generator).
license: Apache-2.0
metadata:
...
- `ns-code-autonomous` / human flags work as underspecified
