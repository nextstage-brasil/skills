...
4. **Task contract** — when implementing a `pm-unit-test-task-generator` task, follow its scenario checklist
...
| `pm-unit-test-task-generator` | Task contract source |

## Related skills

- `pm-unit-test-task-generator` — planning tasks
