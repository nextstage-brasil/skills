...
- Works exclusively inside `WORKTREE_ROOT` (or `{product_root}/.worktrees/{version_san}/` in standalone) — never the main checkout.
...
```
Implement work unit {unit_id} inside {WORKTREE_ROOT}.
