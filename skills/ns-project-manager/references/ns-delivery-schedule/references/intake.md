...
- Links to `docs/versions/{version_san}/pm/{version_san}-commercial-budget-*.md` (read if present; PM misplaced gate may surface version-root PM legacy names via `../pm-persist.md` — never sweep `sdd/`; do not regenerate FP).
