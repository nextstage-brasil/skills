...
8a. **Checkbox theater** — Do not mark "contexto consultado" in Premissas without reuse inventory + documented reuse discount in Features / FP / hours.
...
12. **Technical voice in narrative** — No class/field/schema/endpoint/framework in Objetivo, Features, fluxos, RNFs, acceptance, risks narrative, premissas (`product-voice.md`). FP origem table may use sizing notation.
