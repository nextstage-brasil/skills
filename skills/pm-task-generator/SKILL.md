...
- **Not this skill:** E2E → `pm-e2e-test-generator`; Backend unit tests → `pm-unit-test-task-generator`
...
- `pm-unit-test-task-generator` — after backend implementation tasks
- `pm-e2e-test-generator` — after frontend tasks with UI
