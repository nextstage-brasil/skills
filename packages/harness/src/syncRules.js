...
export const LEGACY_AGENTS_MD_GENERATED_PATTERN =
  /<!-- harness-agents-md: generated by @nextstage-brasil\/harness agents-md -->\n?/g;

export const LEGACY_SYNC_MANAGED_PATTERN =
  /<!-- harness-sync-managed(?:[^>]*) -->\n?/g;
...
export function updateAgentsSyncMarker(projectRoot) {
  ...
  const next = content
    .replace(LEGACY_AGENTS_MD_GENERATED_PATTERN, '')
    .replace(LEGACY_SYNC_MANAGED_PATTERN, '');
  if (next === content) {
    return;
  }
